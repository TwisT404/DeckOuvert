              ...
              return (
                <View style={styles.container}>
                  <View style={styles.containerDeck}>
                    ...
                    <View>
                      <Text style={styles.text}>Nombre de personnes qui ont aimés :</Text>
                  ...
                  <View style={styles.containerBtn}>
                    <Pressable style={[styles.btn, styles.back]} onPress={() => router.push("/deck/ChooseDecks")}>
                      <Text style={[styles.text, styles.textBtn]}>Retour</Text>
                    </Pressable>
                    
                    <Pressable style={[styles.btn, styles.play]} >
